...
class ContactForm(forms.Form):
    name = forms.CharField(label='Name', max_length=100,required=True)  # Corrected 'lable' to 'label'
    email = forms.EmailField(label='Email',required=True)  # Example of another field
